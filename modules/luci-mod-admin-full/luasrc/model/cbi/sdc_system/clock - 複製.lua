...
o = s:option(Value, "ntpserver1", translate("Time Format"))
o.datatype = "host"
...
o = s:option(Value, "ntpserver2", translate("Time Zone"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
...
o = s:option(Value, "ntpserver3", translate("DST"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
...
o = s:option(Value, "ntpserver4", translate("Brightness"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
...
o = s:option(Value, "ntpserver1", translate("SNMP Server 1"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
...
o = s:option(Value, "ntpserver2", translate("SNMP Server 2"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
...
o = s:option(Value, "ntpserver3", translate("SNMP Server 3"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
...
o = s:option(Value, "ntpserver4", translate("SNMP Server 4"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
...
o = s:option(Value, "ntpserver5", translate("SNMP Server 5"))
o.datatype = "host"
function o.cfgvalue(self, section)
    --return fs.readfile("/SDC/Clock.conf") or ""
	for token in string.gmatch(fs.readfile("/SDC/Clock.conf"), "[^\r\n]+") do
